...
local observe, setProp, delProp, defineProperty,createDeinfePropertyObject =
    Observer.observe,
    Observer.set,
    Observer.del,
    Util.defineProperty,
    Util.createDeinfePropertyObject
    ...
    function()
        it(
            ...
            function()
                ...
                local ob1 = observe(1)
                 lu.assertEquals(ob1).toBeUndefined()
                -- avoid vue instance
                local ob2 = observe(Vue.new())
                 lu.assertEquals(ob2).toBeUndefined()
                -- avoid frozen objects
                local ob3 = observe({})
                 lu.assertEquals(ob3).toBeUndefined()
            end
        )
        ...
        it(
            ...
            function()
                ...
                local ob1 = observe(obj)
                 ...
                 lu.assertEquals(obj.__ob__, ob1)
                -- should've walked children
                 lu.assertEquals(instanceof(obj.a.__ob__, Observer), true)
                 lu.assertEquals(instanceof(obj.b.__ob__, Observer), true)
        ...
        it(
            ...
            function()
                -- on object
                local obj = createDeinfePropertyObject()
                local val = 0
                local getCount = 0
                defineProperty(
                    obj,
        ...
        it(
            ...
            function()
                ...
                local ob1 = observe(arr)
                 ...
                 lu.assertEquals(arr.__ob__, ob1)
                -- should've walked children
                 lu.assertEquals(instanceof(arr[0].__ob__, Observer), true)
                 lu.assertEquals(instanceof(arr[1].__ob__, Observer), true)
            end
        )
        ...
        it(
            ...
            function()
              local NaN = 0/0
                ...
                local ab = obj.a.b
                Dep.target = nil
                 lu.assertEquals(watcher.deps.length, 3) -- obj.a + a + a.b
                obj.a.b = 3
                 lu.assertEquals(watcher.update.calls.count(), 1)
                -- swap object
                obj.a = {b = 4}
                 lu.assertEquals(watcher.update.calls.count(), 2)
                watcher.deps = {}
                ...
                local c = obj.c
                Dep.target = nil
                 lu.assertEquals(watcher.deps.length, 4)
                -- set on the swapped object
                obj.a.b = 5
                 lu.assertEquals(watcher.update.calls.count(), 3)
        ...
        it(
            ...
            function()
                ...
                for _, obj in pairs(objs) do
                     lu.assertEquals(instanceof(obj.__ob__, Observer), true)
                end
            end
        )
