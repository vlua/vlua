-- Generated by node-lua-distiller(version: 0.2.6)  at Sun Dec 22 2019 14:05:24 GMT+0800 (GMT+08:00)
...
__DISTILLER:define("vlua.computed", function(require)
local Util = require("vlua.util")
...
__DISTILLER:define("vlua.ref", function(require)
local Util = require("vlua.util")
local Dep = require("vlua.dep")
local warn = Util.warn
local setmetatable = setmetatable
...
__DISTILLER:define("vlua.callContext", function(require)
local Util = require("vlua.util")
...
__DISTILLER:define("vlua.reactiveCall", function(require)
...
__DISTILLER:define("plugins.generic.binder", function(require)
local Util = require("vlua.util")
local Watcher = require("vlua.watcher")
local pairs = pairs
...
__DISTILLER:define("entryXlua.lua_distilled", function(require)
local vlua = require('vlua.vlua')
local xlua = require('plugins.xlua.xlua')
vlua.use(xlua)
return vlua
end)
...
return __DISTILLER:exec("entryXlua.lua_distilled")